    ...
    <div className="mx-auto text-center max-w-[2000px] pt-4">
      ...
      <div className="flex justify-around mt-10">
        ...
        <div className="flex flex-col rounded-lg justify-between border border-2 border-gray-300 p-4 w-[23%]">
          ...
          <p className="my-2">
            This option uses React Server Components for rendering page on the server side, utilizing the server side client library.
          </p>
          <p className="my-2">
            Both the data fetching and rendering are performed on the server component.
          </p>
          <p className="my-2">
            <a className="text-blue-600" href="https://www.npmjs.com/package/@constructor-io/constructorio-node" rel="noreferrer" target="_blank">constructorio-node</a>
          </p>
          <Link href="/server-components" className="block mt-4 rounded-lg px-4 py-3 bg-blue-400 hover:bg-blue-600 text-white font-semibold tracking-wide">
            Example
          </Link>
        </div>
      </div>
